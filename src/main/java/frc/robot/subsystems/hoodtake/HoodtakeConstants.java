...
public final class HoodtakeConstants {
	...
	public static final double PIVOT_CONVERSION_FACTOR = 2 * Math.PI * (1.0/16.0) * (12.0/18.0);

	public static final double PIVOT_kP = 10;
	public static final double PIVOT_kI = 0;
	public static final double PIVOT_kD = 0;
	public static final double PIVOT_SIM_kP = 35;
	public static final double PIVOT_SIM_kI = 1000;
	public static final double PIVOT_SIM_kD = 0;
	public static final double PIVOT_kS = 0.0069017;
	public static final double PIVOT_kG = 1.0124;
	public static final double PIVOT_kV = 0.47486;
	public static final double PIVOT_kA = 0.031463;
