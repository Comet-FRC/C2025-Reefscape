...
public class RightIntake extends SubsystemBase {
	private final RightIntakeIO io;
	private final RightIntakeIOInputsAutoLogged inputs;
	private final ArmVisualizer3d armVisualizer;

	public RightIntake(RightIntakeIO io) {
		this.io = io;
		this.inputs = new RightIntakeIOInputsAutoLogged();
